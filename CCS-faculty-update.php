...
if (isset($_POST['secretary-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathsecretary' WHERE id=2";
...
if (isset($_POST['head1-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathhead1' WHERE id=3";
...
if (isset($_POST['head2-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathhead2' WHERE id=4";
...
if (isset($_POST['ft1-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft1' WHERE id=5";
...
if (isset($_POST['ft2-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft2' WHERE id=6";
...
if (isset($_POST['ft3-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft3' WHERE id=7";
...
if (isset($_POST['ft4-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft4' WHERE id=8";
...
if (isset($_POST['ft5-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft5' WHERE id=9";
...
if (isset($_POST['ft6-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft6' WHERE id=10";
...
if (isset($_POST['ft7-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft7' WHERE id=11";
...
if (isset($_POST['ft8-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft8' WHERE id=12";
...
if (isset($_POST['ft9-submit'])) {
    ...
    $sql = "UPDATE ccsfaculty SET img='$target_pathft9' WHERE id=13";
...
if (isset($_POST['submit-all'])) {
    ...
    $sqldean = "UPDATE ccsfaculty SET name='$deanname', pos='$deanpos', email='$deanemail' WHERE id=1";
    $sqlsecretary = "UPDATE ccsfaculty SET name='$secretaryname', pos='$secretarypos', email='$secretaryemail' WHERE id=2";
    $sqlhead1 = "UPDATE ccsfaculty SET name='$head1name', pos='$head1pos', email='$head1email' WHERE id=3";
    $sqlhead2 = "UPDATE ccsfaculty SET name='$head2name', pos='$head2pos', email='$head2email' WHERE id=4";
    $sqlft1 = "UPDATE ccsfaculty SET name='$ft1name', pos='$ft1pos', email='$ft1email' WHERE id=5";
    $sqlft2 = "UPDATE ccsfaculty SET name='$ft2name', pos='$ft2pos', email='$ft2email' WHERE id=6";
    $sqlft3 = "UPDATE ccsfaculty SET name='$ft3name', pos='$ft3pos', email='$ft3email' WHERE id=7";
    $sqlft4 = "UPDATE ccsfaculty SET name='$ft4name', pos='$ft4pos', email='$ft4email' WHERE id=8";
    $sqlft5 = "UPDATE ccsfaculty SET name='$ft5name', pos='$ft5pos', email='$ft5email' WHERE id=9";
    $sqlft6 = "UPDATE ccsfaculty SET name='$ft6name', pos='$ft6pos', email='$ft6email' WHERE id=10";
    $sqlft7 = "UPDATE ccsfaculty SET name='$ft7name', pos='$ft7pos', email='$ft7email' WHERE id=11";
    $sqlft8 = "UPDATE ccsfaculty SET name='$ft8name', pos='$ft8pos', email='$ft8email' WHERE id=12";
    $sqlft9 = "UPDATE ccsfaculty SET name='$ft9name', pos='$ft9pos', email='$ft9email' WHERE id=13";
...
window.location= 'CCS-Faculty-Settings.php';</script>";
?>