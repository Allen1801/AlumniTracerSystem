...
<main>
    ...
    <div class="colleges">
        ...
        <div class="colleges-div">
            <?php if($id == "2"){ echo '
                <div class="container">
                    <a href="CAS-Analytics-education.php">
                ...
                ';}elseif($id == "3"){ echo '
                <div class="container">
                    <a href="CBA-Analytics-education.php">
                ...
                ';}elseif($id == "4"){ echo '
                <div class="container">
                    <a href="CCS-Analytics-education.php">
                ...
                ';}elseif($id == "5"){ echo '
                <div class="container">
                    <a href="COED-Analytics-education.php">
                ...
                ';}elseif($id == "6"){ echo '
                <div class="container">
                    <a href="COE-Analytics-education.php">
                ...
                ';}elseif($id == "7"){ echo '
                <div class="container">
                    <a href="CIHM-Analytics-education.php">
                ...
                ';}elseif($id == "8"){ echo '
                <div class="container">
                    <a href="CON-Analytics-education.php">
