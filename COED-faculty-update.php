...
if (isset($_POST['secretary-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathsecretary' WHERE id=2";
...
if (isset($_POST['head1-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathhead1' WHERE id=3";
...
if (isset($_POST['head2-submit'])) {
    $id = $_POST['hidden_id'];

    $uniqimage = rand(100000, 999999);
    
    $tmp_name = $_FILES['photohead2']['tmp_name'];
    $file_name = $_FILES['photohead2']['name'];
    $file_ext = pathinfo($file_name, PATHINFO_EXTENSION);
    ...
    // Move the uploaded file to the desired directory
    $target_dir = 'faculty/COED/';
    $target_pathhead2 = $target_dir . $photo_path;
    move_uploaded_file($tmp_name, $target_pathhead2);
    
    $sql = "UPDATE coedfaculty SET img='$target_pathhead2' WHERE id=4";
...
if (isset($_POST['head3-submit'])) {
    $id = $_POST['hidden_id'];

    $uniqimage = rand(100000, 999999);
    
    $tmp_name = $_FILES['photohead3']['tmp_name'];
    $file_name = $_FILES['photohead3']['name'];
    $file_ext = pathinfo($file_name, PATHINFO_EXTENSION);
    ...
    // Move the uploaded file to the desired directory
    $target_dir = 'faculty/COED/';
    $target_pathhead3 = $target_dir . $photo_path;
    move_uploaded_file($tmp_name, $target_pathhead3);
    
    $sql = "UPDATE coedfaculty SET img='$target_pathhead3' WHERE id=5";
...
if (isset($_POST['head4-submit'])) {
    $id = $_POST['hidden_id'];

    $uniqimage = rand(100000, 999999);
    
    $tmp_name = $_FILES['photohead4']['tmp_name'];
    $file_name = $_FILES['photohead4']['name'];
    $file_ext = pathinfo($file_name, PATHINFO_EXTENSION);
    ...
    // Move the uploaded file to the desired directory
    $target_dir = 'faculty/COED/';
    $target_pathhead4 = $target_dir . $photo_path;
    move_uploaded_file($tmp_name, $target_pathhead4);
    
    $sql = "UPDATE coedfaculty SET img='$target_pathhead4' WHERE id=6";
...
if (isset($_POST['ft1-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft1' WHERE id=7";
...
if (isset($_POST['ft2-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft2' WHERE id=8";
...
if (isset($_POST['ft3-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft3' WHERE id=9";
...
if (isset($_POST['ft4-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft4' WHERE id=10";
...
if (isset($_POST['ft5-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft5' WHERE id=11";
...
if (isset($_POST['ft6-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft6' WHERE id=12";
...
if (isset($_POST['ft7-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft7' WHERE id=13";
...
if (isset($_POST['ft8-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft8' WHERE id=14";
...
if (isset($_POST['ft9-submit'])) {
    ...
    $sql = "UPDATE coedfaculty SET img='$target_pathft9' WHERE id=15";
...
if (isset($_POST['submit-all'])) {
    ...
    $head2name= $_POST['head2name'];
    $head2pos = $_POST['head2pos'];
    $head2email = $_POST['head2email'];

    $head3name= $_POST['head3name'];
    $head3pos = $_POST['head3pos'];
    $head3email = $_POST['head3email'];

    $head4name= $_POST['head4name'];
    $head4pos = $_POST['head4pos'];
    $head4email = $_POST['head4email'];
    ...
    $sqldean = "UPDATE coedfaculty SET name='$deanname', pos='$deanpos', email='$deanemail' WHERE id=1";
    $sqlsecretary = "UPDATE coedfaculty SET name='$secretaryname', pos='$secretarypos', email='$secretaryemail' WHERE id=2";
    $sqlhead1 = "UPDATE coedfaculty SET name='$head1name', pos='$head1pos', email='$head1email' WHERE id=3";
    $sqlhead2 = "UPDATE coedfaculty SET name='$head2name', pos='$head2pos', email='$head2email' WHERE id=4";
    $sqlhead3 = "UPDATE coedfaculty SET name='$head3name', pos='$head3pos', email='$head3email' WHERE id=5";
    $sqlhead4 = "UPDATE coedfaculty SET name='$head4name', pos='$head4pos', email='$head4email' WHERE id=6";
    $sqlft1 = "UPDATE coedfaculty SET name='$ft1name', pos='$ft1pos', email='$ft1email' WHERE id=7";
    $sqlft2 = "UPDATE coedfaculty SET name='$ft2name', pos='$ft2pos', email='$ft2email' WHERE id=8";
    $sqlft3 = "UPDATE coedfaculty SET name='$ft3name', pos='$ft3pos', email='$ft3email' WHERE id=9";
    $sqlft4 = "UPDATE coedfaculty SET name='$ft4name', pos='$ft4pos', email='$ft4email' WHERE id=10";
    $sqlft5 = "UPDATE coedfaculty SET name='$ft5name', pos='$ft5pos', email='$ft5email' WHERE id=11";
    $sqlft6 = "UPDATE coedfaculty SET name='$ft6name', pos='$ft6pos', email='$ft6email' WHERE id=12";
    $sqlft7 = "UPDATE coedfaculty SET name='$ft7name', pos='$ft7pos', email='$ft7email' WHERE id=13";
    $sqlft8 = "UPDATE coedfaculty SET name='$ft8name', pos='$ft8pos', email='$ft8email' WHERE id=14";
    $sqlft9 = "UPDATE coedfaculty SET name='$ft9name', pos='$ft9pos', email='$ft9email' WHERE id=15";

    
    if(mysqli_query($link, $sqldean)){
        mysqli_query($link, $sqlsecretary);
        mysqli_query($link, $sqlhead1);
        mysqli_query($link, $sqlhead2);
        mysqli_query($link, $sqlhead3);
        mysqli_query($link, $sqlhead4);
...
window.location= 'COED-Faculty-Settings.php';</script>";
?>