...
<main> 
    ...
    <div class="affairs containers">
      <h2 class="affairs-title">College of Education  </h2>
      <p class="affairs-subtitle">A.Y. 2022-2023  </p>
      <p class="affairs-subtitle" style="margin-top: -20px;"> <i> coed_@plpasig.edu.ph </i> </p>
      ...
      <div class="officers"> 
        ...
        <div class="officers-card">
        <img src="<?php echo $rowhead2['img'] ?>" class="officers-image">
          <p class="officers-name"> <?php echo $rowhead2['name'] ?> </p>
          <p class="officers-position"> <?php echo $rowhead2['pos'] ?> </p>
          <i><p class="officers-position"> <?php echo $rowhead2['email'] ?> </p></i>
        </div>

        <div class="officers-card">
        <img src="<?php echo $rowhead3['img'] ?>" class="officers-image">
          <p class="officers-name"> <?php echo $rowhead3['name'] ?> </p>
          <p class="officers-position"> <?php echo $rowhead3['pos'] ?> </p>
          <i><p class="officers-position"> <?php echo $rowhead3['email'] ?> </p></i>
        </div>

        <div class="officers-card">
        <img src="<?php echo $rowhead4['img'] ?>" class="officers-image">
          <p class="officers-name"> <?php echo $rowhead4['name'] ?> </p>
          <p class="officers-position"> <?php echo $rowhead4['pos'] ?> </p>
          <i><p class="officers-position"> <?php echo $rowhead4['email'] ?> </p></i>
        </div>
