<?php 
    ...
    $sqldean = mysqli_query($link, "SELECT * FROM coedfaculty where id=1");
    $rowdean = mysqli_fetch_array($sqldean);

    $sqlsecretary = mysqli_query($link, "SELECT * FROM coedfaculty where id=2");
    $rowsecretary = mysqli_fetch_array($sqlsecretary);

    $sqlhead1 = mysqli_query($link, "SELECT * FROM coedfaculty where id=3");
    $rowhead1 = mysqli_fetch_array($sqlhead1);

    $sqlhead2 = mysqli_query($link, "SELECT * FROM coedfaculty where id=4");
    $rowhead2 = mysqli_fetch_array($sqlhead2);

    $sqlhead3 = mysqli_query($link, "SELECT * FROM coedfaculty where id=5");
    $rowhead3 = mysqli_fetch_array($sqlhead3);

    $sqlhead4 = mysqli_query($link, "SELECT * FROM coedfaculty where id=6");
    $rowhead4 = mysqli_fetch_array($sqlhead4);

    $sqlft1 = mysqli_query($link, "SELECT * FROM coedfaculty where id=7");
    $rowft1 = mysqli_fetch_array($sqlft1);

    $sqlft2 = mysqli_query($link, "SELECT * FROM coedfaculty where id=8");
    $rowft2 = mysqli_fetch_array($sqlft2);

    $sqlft3 = mysqli_query($link, "SELECT * FROM coedfaculty where id=9");
    $rowft3 = mysqli_fetch_array($sqlft3);

    $sqlft4 = mysqli_query($link, "SELECT * FROM coedfaculty where id=10");
    $rowft4 = mysqli_fetch_array($sqlft4);

    $sqlft5 = mysqli_query($link, "SELECT * FROM coedfaculty where id=11");
    $rowft5 = mysqli_fetch_array($sqlft5);

    $sqlft6 = mysqli_query($link, "SELECT * FROM coedfaculty where id=12");
    $rowft6 = mysqli_fetch_array($sqlft6);

    $sqlft7 = mysqli_query($link, "SELECT * FROM coedfaculty where id=13");
    $rowft7 = mysqli_fetch_array($sqlft7);

    $sqlft8 = mysqli_query($link, "SELECT * FROM coedfaculty where id=14");
    $rowft8 = mysqli_fetch_array($sqlft8);

    $sqlft9 = mysqli_query($link, "SELECT * FROM coedfaculty where id=15");
    $rowft9 = mysqli_fetch_array($sqlft9);
?>

<!DOCTYPE html>
<html>
<title> Admin | COED-Faculty | PLPATS </title>
...
<form action="COED-faculty-update.php" method="POST" enctype="multipart/form-data">
<input type="hidden" value="<?php echo $id; ?>" name="hidden_id" id="hidden_id">
    ...
    <div class="colleges">
        ...
        <div class="form-content">
            ...
            <div class="form-image">
            <img src="<?php echo $rowhead2['img']; ?>" alt="Business Icon" class="logo" id="previewhead2">
                <label for="file-btn-head2" class="upload-btn"><u>Upload Image</u></label>
                <input type="file" id="file-btn-head2" class="input-field7" name="photohead2" accept="image/*" onchange="loadFileHead2(event)" hidden>
                <button type="submit" name="head2-submit"> Save Image </button>
            </div>
            ...
            <div class="form-input"> 
                ...
                <div class="form-input-div input-name">
                    <p> NAME: </p>
                    <input type="text" name="head2name" id="name" value="<?php echo $rowhead2['name']; ?>">
                </div>

                <div class="form-input-div"> 
                    <p> POSITION: </p>
                    <input type="text" name="head2pos" id="position" value="<?php echo $rowhead2['pos']; ?>">
                </div>

                <div class="form-input-div"> 
                    <p> EMAIL ADDRESS: </p>
                    <input type="text" name="head2email" id="email" value="<?php echo $rowhead2['email']; ?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-content">
            ...
            <div class="form-image">
            <img src="<?php echo $rowhead3['img']; ?>" alt="Business Icon" class="logo" id="previewhead3">
                <label for="file-btn-head3" class="upload-btn"><u>Upload Image</u></label>
                <input type="file" id="file-btn-head3" class="input-field7" name="photohead3" accept="image/*" onchange="loadFileHead3(event)" hidden>
                <button type="submit" name="head3-submit"> Save Image </button>
            </div>
            ...
            <div class="form-input"> 
                ...
                <div class="form-input-div input-name">
                    <p> NAME: </p>
                    <input type="text" name="head3name" id="name" value="<?php echo $rowhead3['name']; ?>">
                </div>

                <div class="form-input-div"> 
                    <p> POSITION: </p>
                    <input type="text" name="head3pos" id="position" value="<?php echo $rowhead3['pos']; ?>">
                </div>

                <div class="form-input-div"> 
                    <p> EMAIL ADDRESS: </p>
                    <input type="text" name="head3email" id="email" value="<?php echo $rowhead3['email']; ?>">
                </div>
            </div>
        </div>
        ...
        <div class="form-content">
            ...
            <div class="form-image">
            <img src="<?php echo $rowhead4['img']; ?>" alt="Business Icon" class="logo" id="previewhead4">
                <label for="file-btn-head4" class="upload-btn"><u>Upload Image</u></label>
                <input type="file" id="file-btn-head4" class="input-field7" name="photohead4" accept="image/*" onchange="loadFileHead4(event)" hidden>
                <button type="submit" name="head4-submit"> Save Image </button>
            </div>
            ...
            <div class="form-input"> 
                ...
                <div class="form-input-div input-name">
                    <p> NAME: </p>
                    <input type="text" name="head4name" id="name" value="<?php echo $rowhead4['name']; ?>">
                </div>

                <div class="form-input-div"> 
                    <p> POSITION: </p>
                    <input type="text" name="head4pos" id="position" value="<?php echo $rowhead4['pos']; ?>">
                </div>

                <div class="form-input-div"> 
                    <p> EMAIL ADDRESS: </p>
                    <input type="text" name="head4email" id="email" value="<?php echo $rowhead4['email']; ?>">
                </div>
            </div>
        </div>
    </div>
