...
<!DOCTYPE html>
<html>
<title> Admin | CIHM-Faculty | PLPATS </title>
...
<form action="CIHM-faculty-update.php" method="POST" enctype="multipart/form-data">
<input type="hidden" value="<?php echo $id; ?>" name="hidden_id" id="hidden_id">
    <div class="colleges">
        ...
        <div class="colleges-header">
            ...
            <h2> College of International Hospitality Management </h2>
        </div>
