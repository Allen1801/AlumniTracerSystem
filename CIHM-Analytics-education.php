...
<html>
<title> Admin | Analytics (CIHM) | PLPATS </title>
...
<main>
    ...
    <div class="colleges-div">
        ...
        <div class="overall-bg">
            <img src="Images/cihm.png" class="overall-logo">
            <p class="overall-label">COLLEGE OF INTERNATIONAL HOSPITALITY MANAGEMENT</p>
        </div>
        ...
        <?php include 'Includes/admin/colleges-canvas-educational.php'; ?>
        
                <hr class="divider">
        
        <p class="form-label" style="margin-top: 20px; text-align:center; font-size: 20px; font-weight:bold;">EXPORT DATA </p>
        <form action="export-education.php" method="POST" style="margin-left: -16px; margin-top: 15px;">
        ...
        <button href="#" name="master" id="report"> <i class="fa fa-briefcase"></i>Extract Data of Masters Degree</button>
        <button href="#" name="doctorate" id="report"> <i class="fa fa-circle-xmark"></i>Extract Data of Doctorate Degree</button>
