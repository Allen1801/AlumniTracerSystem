<?php 
    ...
    $sqldean = mysqli_query($link, "SELECT * FROM casfaculty where id=1");
    $rowdean = mysqli_fetch_array($sqldean);

    $sqlsecretary = mysqli_query($link, "SELECT * FROM casfaculty where id=2");
    $rowsecretary = mysqli_fetch_array($sqlsecretary);

    $sqlhead1 = mysqli_query($link, "SELECT * FROM casfaculty where id=3");
    $rowhead1 = mysqli_fetch_array($sqlhead1);

    $sqlhead2 = mysqli_query($link, "SELECT * FROM casfaculty where id=4");
    $rowhead2 = mysqli_fetch_array($sqlhead2);

    $sqlft1 = mysqli_query($link, "SELECT * FROM casfaculty where id=5");
    $rowft1 = mysqli_fetch_array($sqlft1);

    $sqlft2 = mysqli_query($link, "SELECT * FROM casfaculty where id=6");
    $rowft2 = mysqli_fetch_array($sqlft2);

    $sqlft3 = mysqli_query($link, "SELECT * FROM casfaculty where id=7");
    $rowft3 = mysqli_fetch_array($sqlft3);

    $sqlft4 = mysqli_query($link, "SELECT * FROM casfaculty where id=8");
    $rowft4 = mysqli_fetch_array($sqlft4);

    $sqlft5 = mysqli_query($link, "SELECT * FROM casfaculty where id=9");
    $rowft5 = mysqli_fetch_array($sqlft5);

    $sqlft6 = mysqli_query($link, "SELECT * FROM casfaculty where id=10");
    $rowft6 = mysqli_fetch_array($sqlft6);

    $sqlft7 = mysqli_query($link, "SELECT * FROM casfaculty where id=11");
    $rowft7 = mysqli_fetch_array($sqlft7);

    $sqlft8 = mysqli_query($link, "SELECT * FROM casfaculty where id=12");
    $rowft8 = mysqli_fetch_array($sqlft8);

    $sqlft9 = mysqli_query($link, "SELECT * FROM casfaculty where id=13");
    $rowft9 = mysqli_fetch_array($sqlft9);
?>

<!DOCTYPE html>
<html>
<title> Admin | CAS-Faculty | PLPATS </title>
...
<form action="CAS-faculty-update.php" method="POST" enctype="multipart/form-data">
